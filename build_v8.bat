@echo off
echo Building standard_checker v8...

set SCRIPT=J:/WorkBuddy-work/csres-standards/standard_checker.py
set OUTPUT=J:/WorkBuddy-work/csres-standards/dist/工程助手
set DATA=J:/WorkBuddy-work/csres-standards/all_standards_merged_20260629_092235.json
...
set PORTABLE=D:/tmp/工程助手_portable
set PKG=D:/Personal/Downloads/工程助手_v8.zip
